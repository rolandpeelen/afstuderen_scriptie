...
\HRule \\[0.8cm]
{ \huge \bfseries Viability of WebGL Product Configurators}\\[1cm]
\textsc{\large Understanding Technical and Marketing Limitations}\\[0.5cm]
\HRule \\[1.5cm]
...
\emph{Supervisor:} \\
Dhr. K. \textsc{Winkel} % Supervisor's Name
\end{flushright}
\end{minipage}\\[2cm]
